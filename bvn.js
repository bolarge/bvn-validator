 ...
 app.use(function(req, res, next){
    var auth;
     if (req.headers.authorization) {
      ...
      if (!auth || auth[0] !== 'nimbss4real' || auth[1] !== 'great55&&31L990') {
           
           res.statusCode = 401;

           res.setHeader('WWW-Authenticate', 'Basic realm="One Credit"');
   ...
   app.post("/oapi/bvnValidation", function(req, res, next){
    ...
    app.post("/oapi/generateKeys", function(req, res, next){
