...
const doNameMatch = (request, cachedData) => {
  ...
  return Utils.doNameMatch(specifiedNames, sourceNames);
};
...
const validateWithBvnData = (bvnData, neData) => {
  let bvnDataNames = [bvnData.firstName, bvnData.middleName, bvnData.lastName];
  let bankNames = [neData.otherNames, neData.lastName];
  return Utils.doNameMatch(bankNames, bvnDataNames);
};
